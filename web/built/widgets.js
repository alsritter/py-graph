...
export const ComfyWidgets = {
    FLOAT(node, inputName, inputData, app) {
        ...
        if (defaultInput) {
            config = Object.assign(Object.assign({}, config), { defaultInput: true });
        }
    ...
    BOOLEAN(node, inputName, inputData) {
        let defaultVal = inputData[1]["default"];
        return {
            widget: node.addWidget("toggle", inputName, defaultVal, () => { }, { "on": inputData[1].label_on, "off": inputData[1].label_off })
        };
    },
