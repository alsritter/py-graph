...
function addMultilineWidget(node, name, opts, app) {
    ...
    const widget = {
        ...
        draw: function (ctx, _, widgetWidth, y, widgetHeight) {
            ...
            const visible = app.canvasManager.canvas.ds.scale > 0.5 && this.type === 'customtext';
            const margin = 10;
...
export const ComfyWidgets = {
    ...
    IMAGEUPLOAD(node, inputName, inputData, app) {
        ...
        function showImage(name) {
            ...
            img.src = api.apiURL(`/view?filename=${name}&type=input&subfolder=${subfolder}${app.canvasManager.getPreviewFormatParam()}`);
